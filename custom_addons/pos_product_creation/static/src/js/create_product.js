...
chrome.OrderSelectorWidget.include({
    renderElement: function(){
        ...
        for (var i in self.pos.categories){
            categ.push(self.pos.categories[i]);
        }
        /*for (var i in self.pos.db.category_by_id){
            categ.push(self.pos.db.category_by_id[i].name);
        }*/
        for (var i in self.pos.units){
            unit.push(self.pos.units[i]);
        }
        // console.error(self.pos.db.category_by_id);
